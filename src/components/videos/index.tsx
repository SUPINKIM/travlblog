      ...
      <AnimatePresence>
        {!isVisible && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="w-full h-[600px] p-[24px] flex items-center justify-center"
          >
            <div className="flex flex-wrap min-h-[300px] whitespace-pre-wrap leading-[28px] break-keep bg-white max-w-[800px] rounded-[8px] p-[16px] text-gray-950">
              <span>
                호주 첫날이었어요. 아침 일찍 캐리어만 숙소에 맡기고 무거운
                백팩을 매고 하루 종일 시드니를 돌아다녔어요.
              </span>
              <span>
